...
const Login = (props) => {
  ...
  /*
    useReducer() : if use multiple states in one handler, there is a chance to bring old states.
                   (since they are scheduled separately)

                   Hence, it is better to use useReducer() rather than useState() to
                   get latest states, respectively
